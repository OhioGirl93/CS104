...
{
	Book * item = new Book("book", prodName_, price_, qty_, author_, isbn_);
	return item;
}
...
// Making a new Clothing object
Product* ProductClothingParser::makeProduct()
{
	Clothing * item = new Clothing ("clothing", prodName_, price_, qty_, size_, brand_);
	return item;
}
...
{
	Movie * item = new Movie("movie", prodName_, price_, qty_, genre_, rating_);
	return item;
}
